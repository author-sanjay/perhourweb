    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div>
          ...
          <span style={{ marginLeft: 10, fontSize: 20, color: "grey" }}>
            (15 reviews){" "}
          </span>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        >
          ...
          <div style={{ marginLeft: 10, fontSize: 17, color: "grey" }}>
            {" "}
            New Delhi, India{" "}
          </div>
        </div>
        ...
        >
          ...
          <div style={{ marginLeft: 10, fontSize: 17, color: "grey" }}>
            {" "}
            linkedin.com/company/sansamhar{" "}
          </div>
          <img
            src={link}
            style={{
